                    ...
                    <div className={styles.contentContainer}>
                            ...
                            <div className={styles.codeSection}>
                                ...
                                <div className={styles.codeBlock}>
                                    <code>
                                        ...
                                        <br />
                                        # Supabase Authentication (get from https://supabase.com/)<br />
                                        ...
                                        <br />
                                        # Google AI Studio (get from https://aistudio.google.com/)<br />
                                        # Required for AI features: lease analysis, chat, document analysis<br />
                        ...
                        <section className={styles.section}>
                            ...
                            <div className={styles.apiKeySection}>
                                <h3 className={styles.apiKeyTitle}>Supabase Authentication</h3>
                                <ol className={styles.orderedList}>
                                    <li>Create an account at <a href="https://supabase.com/" target="_blank" rel="noopener noreferrer" className={styles.link}>Supabase.com <ExternalLink className={styles.linkIcon} /></a></li>
                                    <li>Create a new project</li>
                                    <li>Copy the project URL and anon key from Project Settings → API</li>
                                    <li>Add <code>NEXT_PUBLIC_SUPABASE_URL</code> and <code>NEXT_PUBLIC_SUPABASE_ANON_KEY</code> to your <code>.env</code> file</li>
                                    <li>Configure sign-in/sign-up methods (email, Google, etc.) in Authentication → Providers</li>
                                </ol>
                            </div>

                            <div className={styles.apiKeySection}>
                                <h3 className={styles.apiKeyTitle}>Google AI Studio</h3>
                                <ol className={styles.orderedList}>
                                    <li>Create an account at <a href="https://aistudio.google.com/" target="_blank" rel="noopener noreferrer" className={styles.link}>Google AI Studio <ExternalLink className={styles.linkIcon} /></a></li>
                                    <li>Get an API key from the studio</li>
                                    <li>Add <code>GOOGLE_AI_API_KEY</code> to your <code>.env</code> file</li>
                                    <li>Used for lease analysis, chat, and document AI</li>
                                </ol>
                            </div>
                        ...
                        <section className={styles.section}>
                            ...
                            <div className={styles.deploymentOption}>
                                            ...
                                            <ul className={styles.list}>
                                                ...
                                                <li>Add all required environment variables:
                                                    <ul className={styles.list}>
                                                        ...
                                                        <li><code>GOOGLE_AI_API_KEY</code></li>
                                ...
                                <div className={styles.codeBlock}>
                                    <code>
                                        ...
                                        <li>Configure Supabase: Add your production URL to redirect URLs in Supabase Auth settings</li>
                            ...
                            <div className={styles.infoBox}>
                                ...
                                <ul className={styles.list}>
                                    ...
                                    <li>✅ Supabase authentication is working</li>
                                    <li>✅ File uploads are working (UploadThing)</li>
                                    <li>✅ AI features are functioning (Google AI Studio)</li>
